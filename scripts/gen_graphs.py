...
NODES_DSV3_2 = [
    ...
    ("split_kv",         "Split KV"),
    ("cat_k",            "Cat K"),
    ("indexer_q_proj",   "Indexer Q"),
    ("indexer_k_proj",   "Indexer K"),
    ("indexer_score",    "Indexer Score"),
    ("indexer_topk",     "Indexer TopK"),
...
EDGES_DSV3_2 = [
    ...
    ("split_kv",    "cat_k"),
    ("rope_kpe",    "cat_k"),
    ("rms_norm_q",  "indexer_q_proj"),
    ("attn_norm",   "indexer_k_proj"),
    ("indexer_q_proj", "indexer_score"),
    ("indexer_k_proj", "indexer_score"),
    ("indexer_score",  "indexer_topk"),
    ("cat_q",       "causal_attn"),
    ("cat_k",       "causal_attn"),
    ("split_kv",    "causal_attn"),
    ("indexer_topk","causal_attn"),
    ("causal_attn", "o_proj"),
    ("o_proj",      "res_add_attn"),
    ("embed",       "res_add_attn"),
