...
MODEL_NAME = "dsv3_2"
PARTITION_NOTES = (
    "Torch.compile prefill-specialized variant of 73a281a9.  It keeps the "
    "deep-fused attention staging and fused residual/SwiGLU dispatch points, "
    "uses dtype-native router logits for the synthetic bf16 benchmark path, "
    "and exposes a final-hidden-state prefill boundary so the output head can "
    "be handled by a downstream sampler."
)
...
FUSED_OP_GRAPH = {
    ...
    "prefill_last_hidden": ["defer_final_norm", "defer_lm_head"],
}
...
class FlattenedDeepSeekModel(nn.Module):
    def __init__(
        ...
        *,
        ...
        self.prefill_last_hidden = False
